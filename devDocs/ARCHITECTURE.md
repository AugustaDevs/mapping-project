...
See also [TOOLING](TOOLING.md) and [WHAT ABOUT AI](WHAT-ABOUT-AI.md)
...
This doesn't mean we will never use this functionality - over time we will likely adopt tooling like Vite and TypeScript. But here's the key: as we add more advanced functionality we should write blog posts explaining what we are doing and why. This way new developers onboarding to the project can:
